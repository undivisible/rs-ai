...
//! **Building:**
//! ```sh
//! wasm-pack build crates/rs_ai_browser --target web --features wasm
//! ```
//!
...
///
/// Use this on WASM targets — pair with [`crate::provider::BrowserAiProvider`]:
///
/// ```no_run
/// # #[cfg(all(target_arch = "wasm32", feature = "wasm"))]
/// use rs_ai_browser::{wasm_bridge::WasmBrowserBridge, BrowserAiProvider};
///
/// # #[cfg(all(target_arch = "wasm32", feature = "wasm"))]
