...
/// Convert a slice of `rs_ai_core::Message` into Ollama messages.
...
/// Convert `rs_ai_core::ToolDefinition` to Ollama tools.
...
/// Convert Ollama tool calls to `rs_ai_core::ToolCallRequest`.
