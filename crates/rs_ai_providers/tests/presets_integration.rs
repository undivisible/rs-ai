...
fn test_kilo_preset_config() {
    use rs_ai_providers::openai_compatible::presets::kilo;
...
fn test_local_providers() {
    use rs_ai_providers::openai_compatible::presets::{lm_studio, ollama, vllm};
...
fn test_custom_endpoint_configuration() {
    use rs_ai_providers::openai_compatible::presets::vllm;
...
fn test_bedrock_preset() {
    use rs_ai_providers::openai_compatible::presets::bedrock;
...
fn test_together_preset() {
    use rs_ai_providers::openai_compatible::presets::together;
...
fn test_all_presets_accessible() {
    use rs_ai_providers::openai_compatible::presets;
