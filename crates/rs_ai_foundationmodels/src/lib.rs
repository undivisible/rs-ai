...
//! framework (Apple Intelligence), integrated with the [`rs_ai_traits`] ecosystem.
//!
//! # Overview
//!
...
//! - **LanguageModel trait** — [`FoundationModel`] implements [`rs_ai_traits::LanguageModel`]
//! - **Provider trait** — [`FoundationModelProvider`] implements [`rs_ai_traits::Provider`]
//!
//! # Requirements
//!
//! | Requirement | Value |
...
//!
//! ```no_run
//! # async fn example() -> Result<(), rs_ai_foundationmodels::Error> {
//! use rs_ai_foundationmodels::{is_available, respond};
//!
//! if !is_available() {
...
//!
//! ```no_run
//! use rs_ai_foundationmodels::FoundationModelProvider;
...
// Re-export rs_ai_traits types used in public API
// ─── FFI declarations ──────────────────────────────────────────────────────────
...
use rs_ai_traits::{EmbeddingModel, ModelInfo, Provider};
