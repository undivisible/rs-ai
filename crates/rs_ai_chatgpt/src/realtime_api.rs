...
///
/// ```no_run
/// use rs_ai_chatgpt::{ChatGptProvider, GPT_4O_REALTIME};
///
/// # #[tokio::main]
...
///     match event? {
///         rs_ai_chatgpt::realtime_api::ServerEvent::TextDelta { delta, .. } => print!("{delta}"),
///         rs_ai_chatgpt::realtime_api::ServerEvent::ResponseDone { .. } => break,
///         _ => {}
///     }
/// }
/// # Ok(())
