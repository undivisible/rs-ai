...
fn test_openrouter_preset_config() {
    use rai_openai_compatible::presets::openrouter;
...
fn test_kilo_preset_config() {
    use rai_openai_compatible::presets::kilo;
...
fn test_local_providers() {
    use rai_openai_compatible::presets::{ollama, vllm, lm_studio};
...
fn test_custom_endpoint_configuration() {
    use rai_openai_compatible::presets::vllm;
...
fn test_bedrock_preset() {
    use rai_openai_compatible::presets::bedrock;
    ...
    assert_eq!(bedrock::CLAUDE_SONNET_4_6, "anthropic.claude-sonnet-4-20250514");
}

#[test]
fn test_together_preset() {
    use rai_openai_compatible::presets::together;
