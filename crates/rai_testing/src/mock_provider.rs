...
use rai_ai::provider::Provider;
use rai_ai::types::ModelInfo;
    ...
    fn available_models(&self) -> Vec<ModelInfo> {
        ...
        for model in self.models.values() {
            infos.push(ModelInfo {
                ...
                capabilities: rai_ai::CapabilitySet::new()
                    .with(rai_ai::Capability::TextInput)
                    .with(rai_ai::Capability::TextOutput),
            });
        }
        for model in self.embedding_models.values() {
            infos.push(ModelInfo {
                ...
                capabilities: rai_ai::CapabilitySet::new().with(rai_ai::Capability::Embeddings),
            });
        }
        infos
    }
