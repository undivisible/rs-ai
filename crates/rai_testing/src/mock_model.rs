...
use rai_ai::model::{EmbeddingModel, GenerateOptions, LanguageModel};
use rai_ai::prompt::Prompt;
use rai_ai::stream::{AiStream, StreamEvent, SyntheticStreamer};
use rai_ai::structured::{EmbeddingResult, GenerateResult};
use rai_ai::tool::ToolCallRequest;
