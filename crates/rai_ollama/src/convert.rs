...
/// Convert a slice of `rai_ai::Message` into Ollama messages.
...
/// Convert `rai_ai::ToolDefinition` to Ollama tools.
...
/// Convert Ollama tool calls to `rai_ai::ToolCallRequest`.
