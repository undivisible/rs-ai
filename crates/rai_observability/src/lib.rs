...
//!
//! ```rust,ignore
//! use rai_observability::with_observability;
//!
...
fn record_usage_and_latency(span: &Span, usage: &Usage, finish_reason: &FinishReason, latency_ms: u64) {
...
mod tests {
    ...
    use rai_ai::{Capability, CapabilitySet, FinishReason, GenerateResult, ResponseMetadata, Usage};
