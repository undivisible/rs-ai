...
/// Convert a slice of `rusty_ai::Message` into Ollama messages.
...
/// Convert `rusty_ai::ToolDefinition` to Ollama tools.
...
/// Convert Ollama tool calls to `rusty_ai::ToolCallRequest`.
